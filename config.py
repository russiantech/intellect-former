...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = getenv('db_url', 'sqlite:///')
...
class ProductionConfig(Config):
    ...
    MAIL_DEBUG = False
    DEFAULT_MAIL_SENDER = getenv('DEFAULT_MAIL_SENDER') 
    MAIL_SERVER = getenv('gmail_server')
    MAIL_PORT = getenv('gmail_port')
    MAIL_USE_TLS = getenv('gmail_use_tls')
    MAIL_USERNAME = getenv('gmail_username')
    MAIL_PASSWORD = getenv('gmail_password')
